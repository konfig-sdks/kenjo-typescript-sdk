 ...
 * 
 * @export
 * @interface EmployeesCreateInactiveEmployeeRequestWork
 */
export interface EmployeesCreateInactiveEmployeeRequestWork {
    /**
     * The company id of the Kenjo employee. This field is required and must to match with Kenjo _id of an existing company.
     * @type {string}
     * @memberof EmployeesCreateInactiveEmployeeRequestWork
     */
    'companyId': string;
    /**
