 ...
 * 
 * @export
 * @interface TimeOffGetRequestsByDateResponseMetadata
 */
export interface TimeOffGetRequestsByDateResponseMetadata {
    /**
     * The number of rows retrieved according the pagination filters (limit + offset).
     * @type {number}
     * @memberof TimeOffGetRequestsByDateResponseMetadata
     */
    'count'?: number;
    /**
