 ...
 * 
 * @export
 * @interface CompensationGetSalariesListResponseMetadata
 */
export interface CompensationGetSalariesListResponseMetadata {
    /**
     * The number of rows retrieved according the pagination filters (limit + offset).
     * @type {number}
     * @memberof CompensationGetSalariesListResponseMetadata
     */
    'count'?: number;
    /**
