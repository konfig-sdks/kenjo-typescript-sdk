 ...
 * 
 * @export
 * @interface EmployeesListPersonalsResponseDataInner
 */
export interface EmployeesListPersonalsResponseDataInner {
    /**
     * The _id of the Kenjo employee.
     * @type {string}
     * @memberof EmployeesListPersonalsResponseDataInner
     */
    '_id'?: string;
    /**
