 ...
 * 
 * @export
 * @interface EmployeesCreateInactiveEmployeeResponsePersonal
 */
export interface EmployeesCreateInactiveEmployeeResponsePersonal {
    /**
     * The name of the Kenjo employee. This field is required.
     * @type {string}
     * @memberof EmployeesCreateInactiveEmployeeResponsePersonal
     */
    'firstName'?: string;
    /**
