 ...
 * 
 * @export
 * @interface CompensationListContractTypesResponseMetadata
 */
export interface CompensationListContractTypesResponseMetadata {
    /**
     * The number of rows retrieved according the pagination filters (limit + offset).
     * @type {number}
     * @memberof CompensationListContractTypesResponseMetadata
     */
    'count'?: number;
    /**
