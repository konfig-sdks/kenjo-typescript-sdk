 ...
 * 
 * @export
 * @interface EmployeesCreateInactiveEmployeeRequestWorkSchedule
 */
export interface EmployeesCreateInactiveEmployeeRequestWorkSchedule {
    /**
     * Allow to indicate if mondays are working days for the employee.
     * @type {boolean}
     * @memberof EmployeesCreateInactiveEmployeeRequestWorkSchedule
     */
