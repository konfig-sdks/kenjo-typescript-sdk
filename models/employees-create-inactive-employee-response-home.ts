 ...
 * 
 * @export
 * @interface EmployeesCreateInactiveEmployeeResponseHome
 */
export interface EmployeesCreateInactiveEmployeeResponseHome {
    /**
     ...
     * @type {string}
     * @memberof EmployeesCreateInactiveEmployeeResponseHome
     */
