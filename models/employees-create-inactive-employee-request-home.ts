 ...
 * 
 * @export
 * @interface EmployeesCreateInactiveEmployeeRequestHome
 */
export interface EmployeesCreateInactiveEmployeeRequestHome {
    /**
     ...
     * @type {string}
     * @memberof EmployeesCreateInactiveEmployeeRequestHome
     */
