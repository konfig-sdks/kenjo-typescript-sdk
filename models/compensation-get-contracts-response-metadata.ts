 ...
 * 
 * @export
 * @interface CompensationGetContractsResponseMetadata
 */
export interface CompensationGetContractsResponseMetadata {
    /**
     * The number of rows retrieved according the pagination filters (limit + offset).
     * @type {number}
     * @memberof CompensationGetContractsResponseMetadata
     */
    'count'?: number;
    /**
