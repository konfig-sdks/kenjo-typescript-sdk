 ...
 * 
 * @export
 * @interface AttendanceGetCategoriesResponseDataInner
 */
export interface AttendanceGetCategoriesResponseDataInner {
    /**
     * The Kenjo _id of the returned attendance category.
     * @type {string}
     * @memberof AttendanceGetCategoriesResponseDataInner
     */
    '_id'?: string;
    /**
