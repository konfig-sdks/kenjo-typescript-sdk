 ...
 * 
 * @export
 * @interface AttendanceGetExpectedTimeByUserResponseMetadata
 */
export interface AttendanceGetExpectedTimeByUserResponseMetadata {
    /**
     * The number of rows retrieved according the pagination filters (limit + offset).
     * @type {number}
     * @memberof AttendanceGetExpectedTimeByUserResponseMetadata
     */
    'count'?: number;
    /**
