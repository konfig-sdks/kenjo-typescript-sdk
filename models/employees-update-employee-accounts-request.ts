 ...
 * 
 * @export
 * @interface EmployeesUpdateEmployeeAccountsRequest
 */
export interface EmployeesUpdateEmployeeAccountsRequest {
    /**
     * The employee email in Kenjo. This is an unique identifier and required.
     * @type {string}
     * @memberof EmployeesUpdateEmployeeAccountsRequest
     */
    'email'?: string;
    /**
